...
import MainFooter from "@/components/project/lawHelp/MainFooter"; 
...
const Footer: FC<PropsType> = ({ data }) => {
  ...
  switch (options) {
    ...
    case "3":
      return (
        <footer
        className={`${nemgoo?.sectionClassName}`}>
        <MainFooter
          options={nemgoo}
        />
      </footer>
    ...
    default:
      return (
        <>
          <Subscribe />
          <div className=" w-full md:h-[450px] sm:h-auto xs:h-auto bg-[url('/images/footerBackground.png')]">
