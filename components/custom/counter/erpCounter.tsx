          ...
          return (
            ...
            >
              <div className="text-center">
                <p className="xl:text-5xl lg:text-3xl xs:text-3xl font-semibold leading-10 text-[#3C3C3C]">
                  {item?.countNumber}+
                </p>
                <p className="xl:text-base lg:text-[14px] xs:text-[12px] font-medium leading-none text-[#67748E] mt-4">
                  {/* {item?.title} */}
                  {t(item.title)}
                </p>
              </div>
