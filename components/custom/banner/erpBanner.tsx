...
export default function ErpBanner({
  ...
  const content = (item: any) => {
    switch (options?.contentStyle) {
      ...
      case "lawHome":
        return (
          <div className={`md:h-[400px] sm:h-[300px] ${options?.className}`}>
            <Image
              src="https://res.cloudinary.com/df3tnewkg/image/upload/v1702882912/cover-22_1_gacxde.png"
              alt=""
              fill
              className="xs:object-contain md:object-cover"
            />
              ...
              <div className="container mx-auto">
                <div className="w-6/12">
                  <RenderAtom
                    ...
                    renderType="title"
                    customClassName={
                      "lg:text-[35px] sm:text-[32px] xs:text-[28px] lg:font-bold sm:font-medium xs:font-normal py-5 line-clamp-2"
                    }
                  />
                  <RenderAtom
                    item={{ value: staticItem1?.description }}
                    renderType="text"
                    customClassName={
                      "lg:text-[16px] sm:text-[14px] xs:text-[12px] sm:font-medium xs:font-normal text-[#ffffff] line-clamp-3"
                    }
                  />
                </div>
              </div>
