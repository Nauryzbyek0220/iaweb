        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="relative flex flex-row py-10">
              <input
                {...register("newlink")}
                className="border-#E1E1E1 md:h-[45px]  sm:h-[50px] xs:h-[40px] xs:w-[320px] sm:w-[350px] md:w-[850px] rounded-full border pl-5 xl:text-[18px] lg:text-[16px] xs:text-[14px] text-[#90A0B7]"
                placeholder={t("WPD_0063")}
              ></input>
              {errors.newlink && (
