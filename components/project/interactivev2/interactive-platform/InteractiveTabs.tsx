...
import InteractivePlatformMain from "./InteractivePlatformMain";
import InteractivePlatformUsage from "./InteractivePlatformUsage";
import InteractivePlatformSignificance from "./InteractivePlatformSignificance";
...
export default function InteractiveTabs() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {activeTab === "001" && <InteractivePlatformMain />}

      {activeTab === "002" && <InteractivePlatformUsage />}

      {activeTab === "003" && <InteractivePlatformSignificance />}
    </div>
  );
}
